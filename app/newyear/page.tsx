        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600">Волшебные костюмы для новогодних праздников и утренников</p>
            </div>

            <div className="mt-16">
              <Card className="bg-white border-amber-200">
                <CardContent className="p-8 text-center">
                  <h2 className="text-2xl font-semibold text-slate-700 mb-4">Новогодние костюмы скоро!</h2>
                  <p className="text-slate-600 mb-6">
                    Мы готовим волшебную коллекцию новогодних костюмов для незабываемых праздников. Следите за
