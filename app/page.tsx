...
export default function HomePage() {
  ...
  const [ageFilter, setAgeFilter] = useState<"children" | "adults">("children")
  ...
  const filteredCategories = categories.filter((category) => category.age_category === ageFilter)
    ...
    <div className="min-h-screen bg-white relative">
      ...
      <section className="py-16 relative bg-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/children-and-adults-in-colorful-carnival-costumes-.jpg"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center mb-8">
              <div className="bg-white rounded-full p-1 shadow-md border border-amber-200">
                <button
          ...
          {loading ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-semibold text-slate-700 mb-4">Загружаем каталог...</h3>
            </div>
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-semibold text-slate-700 mb-4">
                {ageFilter === "children" ? "Детские костюмы готовятся" : "Взрослые костюмы готовятся"}
              </h3>
              <p className="text-slate-600 mb-6 max-w-md mx-auto">
                Мы наполняем каталог костюмами. Скоро здесь появятся удивительные костюмы для ваших праздников!
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredCategories.map((category) => (
                <Link key={category.id} href={`/category/${category.id}`} className="group h-full">
                  <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 group-hover:scale-105 bg-white border-amber-200 h-full flex flex-col">
                    <div className="relative h-48 overflow-hidden flex-shrink-0">
                      ...
                      <div className="absolute top-4 right-4">
                        <Badge className="bg-yellow-400 text-amber-800">
                          {typeof category.count === "number" ? `${category.count} костюмов` : category.count}
                        </Badge>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-amber-600">
                <li>
                  <span className="text-amber-600">Категории загружаются динамически</span>
                </li>
              </ul>
            </div>
