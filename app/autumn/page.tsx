...
export default function AutumnCostumesPage() {
  const autumnCategories: any[] = []
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-700 mb-4">Праздник осени</h1>
              <p className="text-xl text-slate-600">Костюмы для празднования золотой осени и урожая</p>
            </div>

            {/* Removed the grid section for categories as the categories array is now empty */}
              ...
              <Card className="bg-white border-amber-200">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-slate-600 mb-6">
                    Мы постоянно расширяем нашу коллекцию осенних костюмов. Следите за обновлениями или свяжитесь с нами
                    для уточнения наличия.
                  </p>
