...
export default function CarnivalCostumesPage() {
  const carnivalCategories: any[] = []
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-700 mb-4">Карнавальные костюмы</h1>
              <p className="text-xl text-slate-600">Яркие и веселые костюмы для детских праздников и карнавалов</p>
            </div>
            ...
            <div className="mt-16">
              <Card className="bg-white border-amber-200">
                <CardContent className="p-8 text-center">
                  <h2 className="text-2xl font-semibold text-slate-700 mb-4">Карнавальные костюмы скоро!</h2>
                  <p className="text-slate-600 mb-6">
                    Мы готовим яркую коллекцию карнавальных костюмов для незабываемых праздников. Следите за
                    обновлениями или свяжитесь с нами для уточнения наличия.
                  </p>
