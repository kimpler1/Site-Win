...
function NewCostumePageContent() {
  ...
  const [additionalCharacteristics, setAdditionalCharacteristics] = useState<AdditionalCharacteristic[]>([
    { id: "chest", name: "Полуобхват в груди", value: "" },
    { id: "length", name: "Длина сарафана", value: "" },
    { id: "material", name: "Материал", value: "" },
  ])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newCostume = {
      ...
      available: true, // автоматически устанавливаю в true, убрал чекбокс
      characteristics,
    }

    costumeService.create(newCostume)
        ...
        <div className="flex h-16 items-center px-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Добавить костюм</p>
            </div>
          </div>
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <div className="max-w-2xl mx-auto">
            <div className="mb-6">
              <h2 className="text-3xl font-bold text-foreground">Добавить новый костюм</h2>
              <p className="text-muted-foreground">Заполните информацию о костюме</p>
            </div>
                ...
                <CardContent className="space-y-4">
                  <div className="p-3 bg-muted rounded-lg">
                    <p className="text-sm font-medium">
                      Возрастная категория: {selectedAgeCategory === "children" ? "Для детей" : "Для взрослых"}
                    </p>
                    <p className="text-xs text-muted-foreground">Изменить можно в дашборде</p>
                  </div>
