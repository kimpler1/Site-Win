        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-700 mb-4">Русские костюмы</h1>
              <p className="text-xl text-slate-600">Традиционные русские народные костюмы для детей</p>
            </div>
            ...
            {costumes.length === 0 ? (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-semibold text-slate-700 mb-4">Русские костюмы скоро!</h3>
                <p className="text-slate-600 mb-6 max-w-md mx-auto">
                  Мы готовим коллекцию традиционных русских народных костюмов. Следите за обновлениями!
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {/* Костюмы будут отображаться здесь */}
              </div>
            )}
          </div>
        </div>
