...
export default function MilitaryCostumesPage() {
  const militaryCategories: any[] = []
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-700 mb-4">Военные костюмы</h1>
              <p className="text-xl text-slate-600">
                Исторические и современные военные костюмы для детских праздников
              </p>
            </div>
            ...
            <div className="mt-16">
              <Card className="bg-white border-amber-200">
                <CardContent className="p-8 text-center">
                  <h2 className="text-2xl font-semibold text-slate-700 mb-4">Военные костюмы скоро!</h2>
                  <p className="text-slate-600 mb-6">
                    Мы готовим коллекцию военных костюмов разных эпох и родов войск. Следите за обновлениями или
